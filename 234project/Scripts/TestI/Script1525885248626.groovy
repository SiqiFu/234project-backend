...
WebUI.click(findTestObject('ChangeAmountAndConfirm/button_add to cart'))
...
WebUI.click(findTestObject('ChangeAmountAndConfirm/button_confirm'))

WebUI.acceptAlert()

WebUI.verifyElementText(findTestObject('ChangeAmountAndConfirm/div_Well done You successfully'), 'Well done! You successfully added the transaction.')
